    function main(){
        ...
        //     maps.forEach(function(d){
        //             d.leaflet = makeMap(d.id);
        //             svgOVerlay(d.filePath, d.id, d.colors);
        //         });
        ...
        //     function svgOVerlay(filePath, id, colors) {
        ...
        //                 search          = d3.map(maps, function(d) { return d.id; }),
        //                 colorScale      = d3.scale.quantize()
        ...
        //             //adding overlay to map
        //             featuresOverlay.addTo(search.get(id).leaflet.map);
